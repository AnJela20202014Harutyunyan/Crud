                ...
                <div
                    ...
                    <Form :validation-schema="schema" v-slot="{ errors }" @submit="saveProducts">
                        ...
                        <div class="flex items-center justify-end p-6 border-t border-solid border-slate-200 rounded-b">
                            ...
                            <button
                                class="text-green-500 bg-transparent  border-green-500 hover:bg-green-500 active:bg-green-600 font-bold uppercase text-sm px-6 py-3 rounded outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
